  ...
  const shareOnSocialMedia = (platform, dataUrl) => {
    ...
    image.onload = () => {
      ...
      if (platform === 'twitter') {
        ...
        // Instagram does not support direct posting via a URL, but this is a placeholder
  ...
  return (
    <div className="flex flex-row items-center justify-center h-45 p-4 mt-4">
      ...
      <img
        ...
        className="mb-8 max-w-xs w-50 h-50 object-contain animate-pulse animate-infinite animate-delay animate-ease-linear"
      />

      {/* Caption Generation Button */}
      <Button onClick={openManualModal} className="mb-4 m-4 px-8 py-4 text-lg bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-lg">
        Generate Caption!
      </Button>

      {/* Image Generation Button */}
      <Button onClick={openPromptModal} className="mb-4 m-4 px-8 py-4 text-lg bg-green-500 hover:bg-green-600 text-white rounded-md shadow-lg">
        Generate Image!
      </Button>

      {/* Manual Modal */}
      <Modal isOpen={isManualModalOpen} onClose={closeManualModal} title="Manual Post Generation">
        <CardContent>
          <Input
            value={text}
        ...
        <CardFooter className="flex flex-col items-center">
          <Button onClick={handleGeneratePosts} className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-md mt-2">
            Generate Posts
          </Button>
          ...
          {generatedPosts.linkedin_post && (
            <div className="mt-6 w-full">
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Generated LinkedIn Post:</h3>
                <div
                  className="mt-2 p-4 bg-gray-100 rounded-md"
                  dangerouslySetInnerHTML={{ __html: generatedPosts.linkedin_post }}
                />
              </div>
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Generated Twitter Post:</h3>
                <div
                  className="mt-2 p-4 bg-gray-100 rounded-md"
                  dangerouslySetInnerHTML={{ __html: generatedPosts.twitter_post }}
                />
              </div>
              <div className="mb-4">
                <h3 className="text-lg font-semibold text-gray-800">Generated Instagram Post:</h3>
                <div
                  className="mt-2 p-4 bg-gray-100 rounded-md"
                  dangerouslySetInnerHTML={{ __html: generatedPosts.insta_post }}
                />
              </div>
            </div>
          )}
      ...
      {/* Prompt Modal */}
      <Modal isOpen={isPromptModalOpen} onClose={closePromptModal} title="Prompt-Based Post Generation">
        <CardContent>
          <Input
            value={prompt}
            ...
            className="mb-4 p-2 border border-gray-300 rounded-md w-full"
          />
          <Button onClick={getPrompt} className="px-6 py-2 bg-green-500 hover:bg-green-600 text-white rounded-md shadow-md">
            Get Prompt
          </Button>
        </CardContent>
        <CardFooter className="flex flex-col items-center">
          <Button onClick={handleGenerateImage} className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md shadow-md mt-2">
            Generate Image
          </Button>

          {loading && (
            <p className="mt-4 text-gray-600">Please wait while your image is being generated...</p>
          )}

          {imageData && (
            <div className="mt-4 flex flex-col items-center overflow-y-auto max-h-[40vh]">
              <img src={imageData} alt="Generated" className="max-w-full h-auto rounded-md shadow-lg mb-4" />
              ...
              <div className="flex space-x-4">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M3 9a1 1 0 011-1h3V4a2 2 0 014 0v4h3a1 1 0 011 1v2a1 1 0 01-1 1h-3v4a2 2 0 11-4 0v-4H4a1 1 0 01-1-1V9z" clipRule="evenodd" />
                  </svg>
                  Download
                </Button>
